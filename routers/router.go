...
func init() {
	...
	beego.Router("/mindoc/:key/catalog", &controllers.MinDocRestController{}, "get:BookCatalog")
	beego.Router("/mindoc/:key/:id/markdown", &controllers.MinDocRestController{}, "get:BookSectionMarkdown")
	beego.Router("/mindoc/:key/:id/html", &controllers.MinDocRestController{}, "get:BookSectionHtml")
